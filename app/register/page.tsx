...
export default function RegisterPage() {
  ...
  const handleChange = (
    ...
    setErrors((prev) => ({ ...prev, [name]: "" })) // reset error saat user isi
  }
  ...
  const validateStep = (currentStep: number) => {
    ...
    if (currentStep === 1) {
      ...
      if (!formData.skorSpbe) newErrors.skorSpbe = "Skor SPBE wajib diisi"
              ...
              <div className="space-y-4 mt-8 w-full max-w-xs">
                {["1. Isi Data Diri", "2. Isi Detail Konsultasi", "3. Konfirmasi & Tiket", "4. Buat Tiket"].map(
                  (label, i) => (
                    <div
                      key={i}
                      className={`rounded-md py-2 px-4 border border-white/20 ${
                        step === i + 1
                ...
                {[
                  ...
                  <div className="space-y-2" key={field.name}>
                    ...
                    <Input
                      ...
                      className="bg-[#3b3b3b] border-gray-700 text-white"
                    />
                    {errors[field.name] && (
            ...
            {step === 2 && (
              <div className="w-full max-w-md space-y-4">
                ...
                <fieldset className="space-y-2">
                  <Label className="text-white">Topik Konsultasi</Label>
                  {[
                    ...
                    "Pengelolaan SDM SPBE/Pemerintah Digital",
                    ...
                    <div key={item} className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor={item} className="text-white text-sm">
                        {item}
                      </Label>
                    </div>
                  ))}
                  {errors.topikKonsultasi && (
                    <p className="text-red-500 text-xs">{errors.topikKonsultasi}</p>
                  )}
                </fieldset>

                <div className="space-y-2">
                  <Label className="text-white">Fokus Tujuan <span className="text-red-500">*</span></Label>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full p-2 rounded bg-[#3b3b3b] border-gray-700 text-white"
                  />
                  {errors.fokusTujuan && (
                    <p className="text-red-500 text-xs">{errors.fokusTujuan}</p>
                  )}
                </div>

                <div className="space-y-2">
                  <Label className="text-white">Uraian Kebutuhan Konsultasi <span className="text-red-500">*</span></Label>
                  <div className="text-xs text-white/80 mb-1">
                  ...
                  {errors.uraianKebutuhan && (
                    <p className="text-red-500 text-xs">{errors.uraianKebutuhan}</p>
                  )}
                </div>
                ...
                <fieldset className="space-y-2">
                  ...
                  >
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <Label htmlFor="ya" className="text-white">
                        Ya
                      </Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <RadioGroupItem
                        ...
                        className="border-white data-[state=checked]:bg-white data-[state=checked]:text-black"
                      />
                      <Label htmlFor="tidak" className="text-white">
                        Tidak
                      </Label>
                    </div>
                  </RadioGroup>
                  {errors.konsultasiLanjut && (
                    <p className="text-red-500 text-xs">{errors.konsultasiLanjut}</p>
                  )}
                </fieldset>
                ...
                >
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      ...
                      className="border-white data-[state=checked]:bg-white data-[state=checked]:text-black"
                    />
                    <Label htmlFor="wa" className="text-white">
                  ...
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
                      ...
                      className="border-white data-[state=checked]:bg-white data-[state=checked]:text-black"
                    />
                    <Label htmlFor="luring" className="text-white">
                      Luring di Kantor Pusat Kominfo
                    </Label>
                  </div>
                </RadioGroup>
                {errors.mekanisme && (
                  <p className="text-red-500 text-xs">{errors.mekanisme}</p>
                )}

                <div className="space-y-2">
                  <Label className="text-white">Surat Permohonan (opsional)</Label>
