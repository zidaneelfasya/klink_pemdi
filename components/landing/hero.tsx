...
export function Hero() {
  return (
    <section id="beranda" className="relative overflow-hidden bg-background pt-16 md:pt-32 pb-16 md:pb-32">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col gap-6">
            <div className="inline-flex items-center gap-2 bg-primary/10 text-primary w-fit px-3 py-1 rounded-full">
              ...
              <span className="text-sm font-medium">Konsultasi Digital 24/7</span>
            </div>
            ...
            <div>
              ...
              <p className="text-lg text-muted-foreground text-balance">
                Dukung implementasi SPBE dan percepat akses informasi teknis melalui chatbot berbasis RAG yang
                terintegrasi dengan dokumen resmi Komdigi.
              </p>
            </div>
